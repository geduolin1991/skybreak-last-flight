...
public static class SkyVoiceBuildChecks {
 public static void Check(){
  ...
  var bank=JsonUtility.FromJson<SkyVoiceBank>(asset.text);if(bank.clips.Length!=98)throw new Exception("Expected 98 authored voice lines");
  ...
  Directory.CreateDirectory("Build");File.WriteAllText("Build/voice-assets-check.txt","PASS 98 authored, mono voice clips with valid duration\n");Debug.Log("SKYBREAK_VOICE_ASSETS_OK");
 }
}
