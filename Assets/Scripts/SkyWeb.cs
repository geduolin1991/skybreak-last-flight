...
public partial class SkyGame {
 ...
 [System.Serializable] class WebSnapshot {
  ...
  public SkyWorld.SceneryAnchor[] sceneryAnchors;public float sceneryTravel;
 ...
 public void WebStatus() {
  SkyWebReport(JsonUtility.ToJson(new WebSnapshot {
   sceneryAnchors=World?World.ReadSceneryAnchors():new SkyWorld.SceneryAnchor[0],sceneryTravel=World?World.SceneryTravel:0,
