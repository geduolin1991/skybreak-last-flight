...
**当前版本：1.8.0 · 手机横屏触控 / 电脑键盘试玩 / macOS 离线单人。**
...
本轮手机界面、原生与网页验证结果见 [1.8 验证记录](Docs/验证记录1.8.md)。三语配音的详细核验见 [1.7 验证记录](Docs/验证记录1.7.md)。历史版本的验证记录继续保留。自动通关与规则检查不等于所有难度、所有设备的长期真人平衡验收。
