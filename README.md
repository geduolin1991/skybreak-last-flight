...
**当前网页版与 Mac 下载版：1.14.0 · 空中解体、海陆坠毁、重甲反击窗口与装备补给。**

## 直接在线试玩

### [▶ 点击进入《裂空》驾驶舱](https://geduolin1991.github.io/skybreak-last-flight/)

手机与电脑使用同一个链接。手机自动进入触屏界面，点击「加载游戏」，载入后可直接竖屏进入驾驶舱，也可横屏游玩；左手摇杆，右手技能，默认自动开火。电脑保留键盘操作。无需安装 Unity，进度保存在当前浏览器。

1.14.0 重做九种敌机和四类补给，击落后可在空中解体，或拖烟翻滚坠向海面与地面；重炮机与母舰拥有重装防护、散热舱开合和破甲状态。详见 [敌机与坠落反馈](Docs/敌机与坠落反馈1.14.md)。

1.13.0 重做岚刃、赤垒、霜环三台原创机甲，加入翼刃截弹、有限迎击盾和多目标棱镜，三章民用行动会在 Boss 战创造反击窗口。新增 21 段三语战术配音和六种机械音效。详见 [机甲与战局反转](Docs/机甲与战局反转1.13.md)。

1.12.0 增加完整战役叙事、三种任务结果对应的结局与重温档案，新增三语配音、Boss 和结局音乐、城市交通及天气联动、轨道机械动画。详见 [完整战役与结局](Docs/完整战役与结局_1.12.md)。其他游戏可以复用 [独立网页发布要求](Docs/其他游戏独立网页发布说明.md)。

1.9.2 将状态栏移出战场，竖屏提供独立的镜头和下方触控区，保留横屏建议但允许两种方向继续飞行；暂停时可调整画质。详见 [横竖屏适配记录](Docs/手机横竖屏1.9.2.md)。保留 1.9.1 的人物比例修复、纹理过滤和三档画质。
...
[本轮更新与验证范围](Docs/敌机与坠落反馈1.14.md) · 推荐手机横屏，竖屏也能完整游玩。
...
3. 在机库选择战机，按 Enter 开始行动；Enter 推进剧情、Esc 跳过本段；阅读简报后再次按 Enter 出击。
...
- **分层击落反馈**：空中解体、拖烟坠落、水花与涟漪、地面爆燃；效果复用固定数量的对象。
- **重甲敌人**：铁砧重炮机、蜂巢母舰齐射后打开散热舱，抓住短暂窗口集中火力，低血量时永久破甲。
- **装备补给**：绿色修复舱、橙色弹药架、青色反应堆电池和金色双机支援信标。
...
- `Tools`：可编辑 Blender 源文件和资产生成工具；本轮新增 `EnemyFoundry1.14.blend`，机体与历史生产场景继续保留。
